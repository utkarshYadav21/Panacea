...
const Calender = () => {
  ...
  return (
    <div className="scheduler-container mt-[5%] py-[10%]">
      ...
      <input className='text-black my-4' type="date" value={selectedDate} onChange={handleDateChange} min={new Date().toISOString().split('T')[0]} />
      </div>
    <div className='text-center'>
      ...
      <button onClick={handleBookSlot} disabled={!selectedDate || !selectedSlot} className='type py-2 my-[5%] w-[80%] rounded-full text-black font-semibold'>
        Book Slot
      </button>
